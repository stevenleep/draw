export class ToolbarRenderer {
    ...
    const mainTools = [
      {
        ...
        title: "选择工具 (V)",
        active: true,
        svg: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4 2L12 10L8 14L6.4 10L4 2Z" stroke="currentColor" stroke-width="1.5" fill="none"/></svg>',
      },
      {
        mode: "pen",
        title: "画笔工具 (P)",
        svg: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2 14L14 2M14 2L10 2M14 2L14 6" stroke="currentColor" stroke-width="1.5"/></svg>',
      },
      {
        mode: "text",
        title: "文字工具 (T)",
        svg: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 4H13V6H9V14H7V6H3V4Z" stroke="currentColor" stroke-width="1.5"/></svg>',
      },
    ];
    const shapeTools = [
      {
        mode: "rectangle",
        title: "矩形 (R)",
        svg: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="3" y="3" width="10" height="10" stroke="currentColor" stroke-width="1.5" fill="none"/></svg>',
      },
      {
        mode: "circle",
        title: "椭圆 (O)",
        svg: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><ellipse cx="8" cy="8" rx="5.5" ry="5.5" stroke="currentColor" stroke-width="1.5" fill="none"/></svg>',
      },
      {
        mode: "line",
        title: "直线 (L)",
        svg: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><line x1="3" y1="13" x2="13" y2="3" stroke="currentColor" stroke-width="1.5"/></svg>',
      },
      {
        mode: "arrow",
        title: "箭头 (A)",
        svg: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 13L13 3M13 3L13 8M13 3L8 3" stroke="currentColor" stroke-width="1.5"/></svg>',
      },
      {
        mode: "triangle",
        title: "三角形",
        svg: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><polygon points="8,3 13,13 3,13" stroke="currentColor" stroke-width="1.5" fill="none"/></svg>',
      },
      {
        mode: "star",
        title: "五角星",
        svg: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><polygon points="8,3 9.6,7.2 13.6,7.8 10.8,11 11.6,15 8,13 4.4,15 5.2,11 2.4,7.8 6.4,7.2" stroke="currentColor" stroke-width="1.5" fill="none"/></svg>',
      },
    ];
    return `
      <div class="draw-toolbar-content">
        <div class="figma-toolbar-section">
          <div class="figma-toolbar-group">
            ${mainTools
              .map(
                (tool) => `
              <button class="draw-tool-btn${tool.active ? " active" : ""}" data-mode="${tool.mode}" title="${tool.title}">
                ${tool.svg}
              </button>
            `,
              )
        ...
        <div class="figma-toolbar-section">
          <div class="figma-toolbar-group shape-group">
            <button class="draw-tool-btn shape-main-btn" data-mode="rectangle" title="形状工具 (S)">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="3" y="3" width="10" height="10" stroke="currentColor" stroke-width="1.5" fill="none"/></svg>
              <svg class="dropdown-arrow" width="8" height="8" viewBox="0 0 8 8" fill="none"><path d="M2 3L4 5L6 3" stroke="currentColor" stroke-width="1.5"/></svg>
            </button>
            <div class="shape-dropdown">
              ${shapeTools
                .map(
                  (tool) => `
                <button class="draw-tool-btn shape-btn" data-mode="${tool.mode}" title="${tool.title}">
                  ${tool.svg}
                </button>
              `,
                )
        ...
        <div class="figma-toolbar-section">
          <div class="figma-toolbar-group">
            <button class="draw-tool-btn" id="undo-btn" title="撤销 (Ctrl+Z)">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <button class="draw-tool-btn" id="clear-btn" title="清空画布">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <div class="figma-toolbar-section">
          <div class="figma-toolbar-group">
            <button class="draw-tool-btn" id="capture-btn" title="截图">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <button class="draw-tool-btn" id="toggle-props-btn" title="属性面板">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <button class="draw-tool-btn" id="settings-btn" title="设置">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
  ...
  private getToolbarStyles(): string {
    return `
      ...
      #drawing-toolbar-overlay .draw-toolbar-content {
      ...
      #drawing-toolbar-overlay .draw-tool-btn {
      ...
      #drawing-toolbar-overlay .draw-tool-btn:hover {
        background: rgba(0, 0, 0, 0.06) !important;
        transform: translateY(-1px) !important;
        box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1) !important;
      }

      #drawing-toolbar-overlay .draw-tool-btn.active {
